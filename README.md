...
| `OLLAMA_BASE_URL` | `http://192.168.50.49:11434` | Base URL of the local Ollama server used by the **Ask** (natural-language query) feature. Use the homelab host IP so the container can reach it. |
